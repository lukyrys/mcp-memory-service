...
async def detailed_health_check(
    ...
    Requires read access so the dashboard can fetch system status
    without needing write privileges. Information disclosure is
    mitigated by limiting system details to memory/disk usage
    percentages — no OS version, Python version, absolute paths,
